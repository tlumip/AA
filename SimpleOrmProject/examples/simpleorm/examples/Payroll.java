...
//		}
		...
		@Override public SRecordMeta<Period> getMeta() {
			return meta;
		};
	}
...
//		}
		...
		static final SFieldInteger YEAR = new SFieldInteger(meta, "YEAR_NR", SPRIMARY_KEY); 
		...
		@Override public SRecordMeta<PaySlip> getMeta() {
			return meta;
		};
	}
...
//		}
		...
		@Override public SRecordMeta<PaySlipDetail> getMeta() {
			return meta;
		};
	}
...
//		}
		...
		@Override public SRecordMeta<UglyPaySlipDetail> getMeta() {
			return meta;
		};
	}
}
