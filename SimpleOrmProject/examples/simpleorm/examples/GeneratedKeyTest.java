...
//		}
		...
		@Override public SRecordMeta<Invoice> getMeta() {
			return meta;
		};
	...
	static void genTest() throws Exception {
		...
		inv1.setString(inv1.NAME, "Dummy"); // Needed for Derby, else no columns at all.
		...
		//TestUte.assertEqual("Key1 1", "Key1 " + key1); // May not always be true in all dbs.
		inv1.validated = false;
		ses.flush();
		TestUte.assertTrue(inv1.validated);
