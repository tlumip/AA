...
abstract public class SGenerator {
	...
	/** Called to set a generator for a mode.
	 * (The SDataSet layer does not know about the actual generators, thus the two steps.)
	 */
    ...
    /** Can prevent key being included in Insert T (XXX) for Derby. */
    boolean includeGeneratedKeysInInsertValues(SSessionJdbc session){return true;}
    ...
    @Override public String toString(){return "[Generator " + keyField + ": " + keyField.getGeneratorMode() + "]";
    }
}
